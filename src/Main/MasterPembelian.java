 ...
 * @author xyz
 */
public final class MasterPembelian extends javax.swing.JFrame {
    ...
    public void tampildata() {
        ...
        tabelnyo.addColumn("No pembelian");
        tabelnyo.addColumn("Tanggal Beli");
        tabelnyo.addColumn("Supplier");
        tabelnyo.addColumn("Kode Barang");
        tabelnyo.addColumn("Jumlah");
        tabelnyo.addColumn("SubTotal");

        try {
            conn.sn = conn.cn.createStatement();
            String sql = "SELECT p.id, p.`tglbeli`, s.`nama`, d.`kodebarang`, d.`jumlah`, d.`subtotal` "
                    + "FROM pembelian p "
                    + "INNER JOIN supplier s "
                    + "ON p.`idsup` = s.`id` "
                    + "LEFT JOIN detail_pembelian d "
                    + "ON p.`id` = d.`id` "
                    + "ORDER BY p.`tglbeli` DESC";
    ...
    private void initComponents() {
        ...
        setTitle("Master Pembelian");
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel1.setText("Cari Berdasarkan no pembelian/ nama supplier");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterPembelian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MasterPembelian().setVisible(true);
            }
        });
    }
