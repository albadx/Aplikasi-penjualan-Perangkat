...
public final class Penjualan extends javax.swing.JFrame {
    ...
    public Penjualan() {
        ...
        Tabel(jTable1, new int[]{105, 300, 90, 60, 60, 130});
        AUTONUMBER();
    ...
    private void initComponents() {
        ...
        Sisa.setDisabledTextColor(new java.awt.Color(0, 0, 0));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Bayar)
                            .addComponent(Sisa, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(SubTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        try {
            ...
            String b = tanggal;
            String c = Bayar.getText();
            String e = Sisa.getText();
            String f = Total.getText();

            sql = "insert into penjualan values ('" + a + "','" + b + "','" + c + "','" + e + "','" + f + "')";
    ...
    private void TambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TambahActionPerformed
        ...
        if ((NM.isEmpty()) | (KB.isEmpty()) | (JM.isEmpty())) {
            ...
            try {
                ...
                String e = SubTotal.getText();

                String sql = "insert into detail_penjualan values ('" + a + "','" + b + "','" + c + "','" + e + "')";
                conn.sn.executeUpdate(sql);
    ...
    private void SubTotalCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_SubTotalCaretUpdate
        ...
        try {
            long d, ew = 0;
            d = Long.parseLong(SubTotal.getText());
            ew = Long.parseLong(Total.getText());
            ew = ew + d;
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        try {
            ...
            jTextField4.setText(res.getString("hargajual"));
            jTextField5.setText(res.getString("stok"));
        } catch (SQLException ex) {
        }
    ...
    private void BayarCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_BayarCaretUpdate
        long a,b;
        a = Long.parseLong(Bayar.getText());
        b = Long.parseLong(Total.getText());
        b = a - b;
        Sisa.setText(String.valueOf(b));
