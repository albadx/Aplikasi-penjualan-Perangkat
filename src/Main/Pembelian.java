...
public final class Pembelian extends javax.swing.JFrame {
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        try {
            ...
            sql = "insert into pembelian values ('" + a + "','" + b + "','" + c + "','" + e + "')";
    ...
    private void TambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TambahActionPerformed
        ...
        if ((NM.isEmpty()) | (KB.isEmpty()) | (JM.isEmpty())) {
            ...
            try {
                ...
                String sql = "insert into detail_pembelian values ('" + a + "','" + b + "','" + c + "','" + e + "')";
                conn.sn.executeUpdate(sql);
...
//            ew = Double.parseDouble(Total.getText());
//            ew = ew + d;
