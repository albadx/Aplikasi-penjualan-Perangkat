 ...
 * @author xyz
 */
public final class MasterPenjualan extends javax.swing.JFrame {
    ...
    public void tampildata() {
        ...
        tabelnyo.addColumn("No Penjualan");
        ...
        try {
            ...
            String sql = "SELECT p.`id`, p.`tglpenjualan`, d.`kodebarang`, d.`jumlah`, d.`subtotal` "
                    + "FROM penjualan p "
                    + "LEFT JOIN detail_penjualan d "
                    + "ON p.`id` = d.`id` "
    ...
    private void initComponents() {
        ...
        setTitle("Master Penjualan");
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel1.setText("Cari Berdasarkan no penjualan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterPenjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MasterPenjualan().setVisible(true);
            }
        });
    }
